/******************************************************************************************************************************************
Program name: /udd/nhsem/Potato.T2D/NHS/stable5_nhs.sas
Name of programmer(s): Seyed Mohammad Mousavi
Dates: 05/06/2024
Purpose of the program: 
   S.Table 5. the associations between total and type of potato consumption and risk of type 2 diabetes in the NHS, adjust for baseline BMI
...
array bmi   {18}  bmi84 bmi84 bmi84 bmi84 bmi84 bmi84 bmi84 bmi84 bmi84 bmi84 bmi84 bmi84 bmi84 bmi84 bmi84 bmi84 bmi84 bmi84;
...
agecon=age{i};
   ...
   if smkk=1 or smkk=0 then smktr=0;
       ...
       /*** Indicator for BMI ***/ 
         bmicon=bmi{i};
        if bmicon = . then bmicon = 24.03000;
         bmia=bmi{i};
         if bmia = . then bmia = 24.030000;        
...
ods rtf file="stable5_pserv_nhs.rtf";  
