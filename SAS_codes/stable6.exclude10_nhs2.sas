...
array nocum19 {*}  aofib19n ceraf19n alco19n calor19n trn1115n sat19n mon19n poly19n gid19n fol9819n prot19n carbo19n carbden19n protden19n tfatden19n transden15n satden19n polyden19n monden19n tpotat19d bbmpot19d fpotat19d chipss19d prmeat19d urmeat19d trmeat19d poultr19d fishal19d regegg19d hdairy19d ldairy19d /*soypro19d*/ nutsal19d legume19d fruits19d vegeal19d nstveg19d staveg19d tdairy19d coffee19d nutleg19d bwrice19d wtrice19d SSB19d whgrn19n rfgrn19n whgrns19d rfgrns19d gl19n afat19d vfat19d ahei19 aheinoal19 aheinopt19 aheifisha19 aheidairy19 aheinutbl19 aheipoult19 aheineggs19;
...
division=div{i};
   ...
   %exclude(0 lt dtdxdiab le retmo01);      /* diabetes in the first 10 years after baseline which is 1991 */
...
%indic3(vbl=cchipsscav, prefix=cchipsscav, reflev=0, min=1, max=4, missing=., usemiss=0);
   ...
   if cchipsscav=2 then medcchipsscav=0.1150000;
...
%indic3(vbl=cfpotatcav, prefix=cfpotatcav, reflev=0, min=1, max=4, missing=., usemiss=0);
   ...
   if cfpotatcav=3 then medcfpotatcav=0.2366667;
...
ods rtf file="stable6.exclude10_nhs2.rtf";  
...
ods rtf file="stable6.exclude10_bbm.nhs2.rtf";  
proc print data=scr noobs;
...
ods rtf file="stable6.exclude10_pserv_nhs2.rtf";  
