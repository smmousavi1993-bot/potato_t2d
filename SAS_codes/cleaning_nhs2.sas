...
Purpose of the program: 
   Read in and merge datasets as the preparation for the analysis of the associations between total and type of potato consumption and risk of type 2 diabetes in the NHS2

/*MI*/
data mi_read;
infile '/mi8917.073120.cases' lrecl=117 recfm=d;
...
data diab_case;
infile '/db8921.080423.cases' lrecl=183 recfm=d;
...
%nur89(keep=wt89 mi89 db89 dbg89 hbp89 str89 chol89 shift89
...
%n91_nts(keep=aofib91n ceraf91n alco91n calor91n trnss91n sat91n mon91n poly91n gid91n gl91n fol91n chol91n prot91n carbo91n tfat91n carbden91n protden91n tfatden91n transden91n satden91n polyden91n monden91n);
            ...
            tfatden91n= (tfat91n*9)/calor91n;
            proc sort; by id; run;


%n95_nts(keep=aofib95n ceraf95n alco95n calor95n trnss95n sat95n mon95n poly95n gid95n gl95n fol95n chol95n prot95n carbo95n tfat95n carbden95n protden95n tfatden95n transden95n satden95n polyden95n monden95n);
            ...
            tfatden95n= (tfat95n*9)/calor95n;

            proc sort; by id; run;

%n99_nts(keep=aofib99n ceraf99n alco99n calor99n trn0099n sat99n mon99n poly99n gid99n gl99n fol9899n chol99n prot99n carbo99n tfat99n carbden99n protden99n tfatden99n transden99n satden99n polyden99n monden99n);
            ...
            tfatden99n= (tfat99n*9)/calor99n;
            proc sort; by id; run;

%n03_nts(keep=aofib03n ceraf03n alco03n calor03n trn0203n sat03n mon03n poly03n gid03n gl03n fol9803n chol03n prot03n carbo03n tfat03n carbden03n protden03n tfatden03n transden03n satden03n polyden03n monden03n);
            ...
            tfatden03n= (tfat03n*9)/calor03n;
            proc sort; by id; run;

%n07_nts(keep=aofib07n ceraf07n alco07n calor07n trn0707n sat07n mon07n poly07n gid07n gl07n fol9807n chol07n prot07n carbo07n tfat07n carbden07n protden07n tfatden07n transden07n satden07n polyden07n monden07n);
            ...
            tfatden07n= (tfat07n*9)/calor07n;
            proc sort; by id; run;

%n11_nts(keep=aofib11n ceraf11n alco11n calor11n trn1111n sat11n mon11n poly11n gid11n gl11n fol9811n chol11n prot11n carbo11n tfat11n carbden11n protden11n tfatden11n transden11n satden11n polyden11n monden11n);
            ...
            tfatden11n= (tfat11n*9)/calor11n;
            proc sort; by id; run;

%n15_nts(keep=aofib15n ceraf15n alco15n calor15n trn1115n sat15n mon15n poly15n gid15n gl15n fol9815n chol15n prot15n carbo15n tfat15n carbden15n protden15n tfatden15n transden15n satden15n polyden15n monden15n);
            ...
            tfatden15n= (tfat15n*9)/calor15n;
            proc sort; by id; run;

%n19_nts(keep=aofib19n ceraf19n alco19n calor19n sat19n mon19n poly19n gid19n gl19n fol9819n chol19n prot19n carbo19n tfat19n carbden19n protden19n tfatden19n satden19n polyden19n monden19n);
...
/* husband education */
   ...
   if shift89=1 then shift89c=1; 
   else if shift89=2 then shift89c=2;
   else if shift89 in (3,4) then shift89c=3;
   else if shift89 in (5,6) then shift89c=4;
   else if shift89=7 then shift89c=5;
   else shift89c=.;

   label shift89c='Years of shift work 89, categorical';

      %indic3(vbl=shift89c, prefix=shift89c, min=2, max=5, reflev=1, usemiss=0,
      label1='Never',
...
/*
   if shift89c=1 then shift89cont=0; 
   else if shift89c=2 then shift89cont=1.5; 
   else if shift89c=3 then shift89cont=4;
   else if shift89c=4 then shift89cont=7.5;
   else if shift89c=5 then shift89cont=12;
   else if shift89c=6 then shift89cont=17;
   else if shift89c=7 then shift89cont=20;
   else shift89cont=.;*/
...
data baseline0;
   set baseline0;
    ...
    ARRAY state_char{15} $ state10_91 state10_93 state10_95 state10_97 state10_99 state10_01 
                         state10_03 state10_05 state10_07 state10_09 state10_11 state10_13 
                         state10_15 state10_17 state10_19 ;

    ARRAY state_num{15} state10_91_num state10_93_num state10_95_num state10_97_num state10_99_num
                       state10_01_num state10_03_num state10_05_num state10_07_num state10_09_num 
                       state10_11_num state10_13_num state10_15_num state10_17_num state10_19_num;
    ...
    DROP state10_91 state10_93 state10_95 state10_97 state10_99 state10_01 
                         state10_03 state10_05 state10_07 state10_09 state10_11 state10_13 
                         state10_15 state10_17 state10_19 ;
RUN;
...
/*
proc corr data=baseline0 spearman ;
  var shift89cont tpotat91d bbmpot91d fpotat91d;
run;
*/