...
Purpose of the program: 
   S.Table 8. Associations between baseline potato intakes and risk of diabetes in the NHS using different types of dietary assessments
...
varlist=calorcav calorv carbov carbdenv carbocav carbdencav alcov alcocav protcav protv protdencav protdenv aofibv aofibcav cerafv cerafcav prmeatv urmeatv trmeatv poultrv 
      fishalv regeggv hdairyv ldairyv /*soyprov*/ prmeatcav urmeatcav trmeatcav poultrcav fishalcav hdairycav ldairycav /*soyprocav*/ nutsalcav legumecav fruitscav fruitsv
...
data six;
  ...
  %indic3(vbl=ctpotatcav, prefix=ctpotatcav, reflev=0, min=1, max=4, missing=., usemiss=0);
   ...
   if ctpotatcav=3 then medctpotatcav=0.5000000;
   if ctpotatcav=4 then medctpotatcav=0.9300000;
...
proc means median data=six;var tpotatcav;class ctpotatcav; run;
proc means median data=six;var fpotatcav;class cfpotatcav; run;
proc means median data=six;var chipsscav;class cchipsscav; run;
proc means median data=six;var bbmpotcav;class cbbmpotcav; run;
...
%mphreg9(data=six, event=diabcase, time=tdiabcase,  
...
ods rtf file="stable8.base_nhs.rtf";  
...
ods rtf file="stable8.base_pserv_nhs.rtf";  
...
ods rtf file="stable8.base.bbm_nhs.rtf";  
proc print data=scr noobs;
