 /******************************************************************************************************************************************
Program name: /udd/nhsem/Potato.T2D/NHS2/stable5_nhs2.sas
Name of programmer(s): Seyed Mohammad Mousavi
Dates: 05/06/2024
Purpose of the program: 
   S.Table 5. the associations between total and type of potato consumption and risk of type 2 diabetes in the NHS II, adjust for baseline BMI
...
array bmi   {15}  bmi91     bmi91    bmi91    bmi91    bmi91    bmi91  bmi91    bmi91     bmi91     bmi91    bmi91   bmi91  bmi91 bmi91  bmi91;
...
agecon=age{i};
   ...
   if smkk=1 or smkk=0 then smktr=0;
       ...
       /*** Indicator for BMI ***/ 
         ...
         if bmicon = . then bmicon = 23.2300000;
...
ods rtf file="stable5.bbm_nhs2.rtf";  
proc print data=scr noobs;
...
ods rtf file="stable5_pserv_nhs2.rtf";  
