...
Purpose of the program: 
   S.Table 8. Associations between cumulative average without most recent potato intakes and risk of diabetes in the NHS II using different types of dietary assessments
...
do i = 1 to DIM(nocum91);
        cumul91{i} = nocum91{i};
        cumul95{i} = nocum91{i};
        cumul99{i} = mean(nocum91{i}, nocum95{i});
        cumul03{i} = mean(nocum91{i}, nocum95{i}, nocum99{i});
        cumul07{i} = mean(nocum91{i}, nocum95{i}, nocum99{i}, nocum03{i});
        cumul11{i} = mean(nocum91{i}, nocum95{i}, nocum99{i}, nocum03{i}, nocum07{i});
        cumul15{i} = mean(nocum91{i}, nocum95{i}, nocum99{i}, nocum03{i}, nocum07{i}, nocum11{i});
        cumul19{i} = mean(nocum91{i}, nocum95{i}, nocum99{i}, nocum03{i}, nocum07{i}, nocum11{i}, nocum15{i});
end;
...
varlist= calorcav calorv carbov carbdenv carbocav carbdencav alcov alcocav protcav protv protdencav protdenv aofibv aofibcav cerafv cerafcav transfv transfdenv transfcav transfdencav satfv satfdenv satfcav satfdencav polyfv polyfdenv polyfcav polyfdencav monfcav monfv monfdencav monfdenv
         prmeatv urmeatv trmeatv poultrv fishalv regeggv hdairyv ldairyv /*soyprov*/ prmeatcav urmeatcav trmeatcav poultrcav hdairycav ldairycav /*soyprocav*/ nutsalcav legumecav fruitscav vegealcav nstvegcav stavegcav gidcav whgrns91d rfgrns91d whgrnscav rfgrnscav fishalcav regeggcav SSBcav
...
%indic3(vbl=cchipsscav, prefix=cchipsscav, reflev=0, min=1, max=4, missing=., usemiss=0);
   ...
   if cchipsscav=2 then medcchipsscav=0.1300000;
   if cchipsscav=3 then medcchipsscav=0.2850000;
   if cchipsscav=4 then medcchipsscav=0.6450000;
...
%indic3(vbl=cfpotatcav, prefix=cfpotatcav, reflev=0, min=1, max=4, missing=., usemiss=0);
   ...
   if cfpotatcav=2 then medcfpotatcav=0.1225000;
   if cfpotatcav=3 then medcfpotatcav=0.2675000;
  ...
  %indic3(vbl=cbbmpotcav, prefix=cbbmpotcav, reflev=0, min=1, max=3, missing=., usemiss=0);
   ...
   if cbbmpotcav=2 then medcbbmpotcav=0.3140000;
...
ods rtf file="stable8.norec_nhs2.rtf";  
...
ods rtf file="stable8.norec_pserv_nhs2.rtf";  
...
ods rtf file="stable8.norec.bbm_nhs2.rtf";  
proc print data=scr noobs;
