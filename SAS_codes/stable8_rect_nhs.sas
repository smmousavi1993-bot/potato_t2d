...
Purpose of the program: 
   S.Table 8. Associations between the most three recent potato intakes and risk of diabetes in the NHS using different types of dietary assessments
...
data five;
  ...
  %indic3(vbl=ctpotatcav, prefix=ctpotatcav, reflev=0, min=1, max=4, missing=., usemiss=0);
   ...
   if ctpotatcav=1 then medctpotatcav=0.1166667;
   if ctpotatcav=2 then medctpotatcav=0.2866667;
...
%indic3(vbl=cchipsscav, prefix=cchipsscav, reflev=0, min=1, max=4, missing=., usemiss=0);
  ...
  %indic3(vbl=cbbmpotcav, prefix=cbbmpotcav, reflev=0, min=1, max=3, missing=., usemiss=0);
   ...
   if cbbmpotcav=1 then medcbbmpotcav=0.1166667;
...
ods rtf file="stable8.rect_nhs.rtf";  
...
ods rtf file="stable8.rect_pserv_nhs.rtf";  
...
/*baked, boiled, mashed potato person-eyar*/
...
ods rtf file="stable8.rect.bbm_nhs.rtf";  
proc print data=scr noobs;
