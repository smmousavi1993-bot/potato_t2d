...
Purpose of the program: 
   S.Table 8. Associations between the most recent three potato intakes and risk of diabetes in the HPFS using different types of dietary assessments
...
do i = 1 to DIM(cumul14);
        ...
        cumul98{i} = mean(nocum90{i}, nocum94{i}, nocum98{i});
        cumul02{i} = mean(nocum94{i}, nocum98{i}, nocum02{i});
        cumul06{i} = mean(nocum98{i}, nocum02{i}, nocum06{i});
        cumul10{i} = mean(nocum02{i}, nocum06{i}, nocum10{i});
        cumul14{i} = mean(nocum06{i}, nocum10{i}, nocum14{i});
end;
...
%indic3(vbl=cchipsscav, prefix=cchipsscav, reflev=0, min=1, max=4, missing=., usemiss=0);
   ...
   if cchipsscav=4 then medcchipsscav=0.6433333;
...
%indic3(vbl=cbbmpotcav, prefix=cbbmpotcav, reflev=0, min=1, max=3, missing=., usemiss=0);
   ...
   if cbbmpotcav=3 then medcbbmpotcav=0.6200000;
...
ods rtf file="stable8.rect_hpfs.rtf";  
...
ods rtf file="stable8.rect_pserv_hpfs.rtf";  
...
ods rtf file="stable8.rect.bbm_hpfs.rtf";  
proc print data=scr noobs;
