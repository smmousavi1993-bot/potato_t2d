...
Purpose of the program: 
   S.Table 8. Associations between cumulative average without most recent potato intakes and risk of diabetes in the HPFS using different types of dietary assessments
...
do i = 1 to DIM(cumul14);
        cumul86{i} = nocum86{i};
        cumul90{i} = nocum86{i};
        cumul94{i} = mean(nocum86{i}, nocum90{i});
        cumul98{i} = mean(nocum86{i}, nocum90{i}, nocum94{i});
        cumul02{i} = mean(nocum86{i}, nocum90{i}, nocum94{i}, nocum98{i});
        cumul06{i} = mean(nocum86{i}, nocum90{i}, nocum94{i}, nocum98{i}, nocum02{i});
        cumul10{i} = mean(nocum86{i}, nocum90{i}, nocum94{i}, nocum98{i}, nocum02{i}, nocum06{i});
        cumul14{i} = mean(nocum86{i}, nocum90{i}, nocum94{i}, nocum98{i}, nocum02{i}, nocum06{i}, nocum10{i});
end;
...
varlist=calorcav calorv alcov alcocav prmeatv urmeatv trmeatv poultrv fishalv regeggv hdairyv ldairyv tdairyv nutlegv legumev fruitsv soyprov nstvegv stavegv bwricev wtricev SSBv
        tpotatcav bbmpotcav fpotatcav chipsscav prmeatcav urmeatcav trmeatcav poultrcav hdairycav ldairycav soyprocav nutsalcav legumecav fruitscav vegealcav nstvegcav stavegcav gidcav SSBcav tdairycav nutlegcav bwricecav wtricecav fishalcav regeggcav
...
data five;
  ...
  %indic3(vbl=ctpotatcav, prefix=ctpotatcav, reflev=0, min=1, max=4, missing=., usemiss=0);
   ...
   if ctpotatcav=2 then medctpotatcav=0.2833333;
   if ctpotatcav=3 then medctpotatcav=0.5525000;
   if ctpotatcav=4 then medctpotatcav=0.8833333;
...
%indic3(vbl=cchipsscav, prefix=cchipsscav, reflev=0, min=1, max=4, missing=., usemiss=0);
   ...
   if cchipsscav=3 then medcchipsscav=0.2850000;
   if cchipsscav=4 then medcchipsscav=0.6880000;
...
%indic3(vbl=cfpotatcav, prefix=cfpotatcav, reflev=0, min=1, max=4, missing=., usemiss=0);
   ...
   if cfpotatcav=2 then medcfpotatcav=0.1300000;
   if cfpotatcav=3 then medcfpotatcav=0.2850000;
   if cfpotatcav=4 then medcfpotatcav=0.6580000;
...
%indic3(vbl=cbbmpotcav, prefix=cbbmpotcav, reflev=0, min=1, max=3, missing=., usemiss=0);
   ...
   if cbbmpotcav=2 then medcbbmpotcav=0.3575000;
   if cbbmpotcav=3 then medcbbmpotcav=0.6450000;
...
%pre_pm(
 ...
 out=outpm,
 timevar=period,
 irt=irt86 irt88 irt90 irt92 irt94 irt96 irt98 irt00 irt02 irt04 irt06 irt08 irt10 irt12 irt14 irt16 irt18 irt20,
 cutoff=cutoff,
 dtdx=dtdxdiab,
 dtdth=dtdth,
 case=diabcase,
...
ods rtf file="stable8.norec_hpfs.rtf";  
...
ods rtf file="stable8.norec_pserv_hpfs.rtf";  
...
ods rtf file="stable8.norec.bbm_hpfs.rtf";  
proc print data=scr noobs;
