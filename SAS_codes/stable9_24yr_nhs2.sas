...
array irt   {4}  retmo15  retmo17  retmo19  cutoff;
array perioda  {3}  period1  period2  period3  ;
array tvar  {3}  t15  t17   t19;
array age   {3}  age91     age93    age95;
array aspyn {3}  asp91 asp93 asp95;
array hbp   {3}  hbp91  hbp93   hbp95; 
array chol  {3}  chol91  chol93   chol95;
array db    {3}  db91  db93   db95;
array nsmk  {3}  smkdr91   smkdr93  smkdr95;
array bmi   {3}  bmi91     bmi93    bmi95;
array actm  {3}  act91m act91m act91m;
array horm  {3}  nhor91    nhor93   nhor95;
array mvit  {3}  mvitu91    mvitu93   mvitu95;
array antihp   {3}  hbptx89 hbptx93 hbptx95;
array antitc   {3}  hchtx93 hchtx93 hchtx95;

array calorca  {3}  calor91ca calor91ca calor95ca;
array aofibca  {3}  aofib91ca aofib91ca aofib95ca;
array cerafca  {3}  ceraf91ca ceraf91ca ceraf95ca;
array alcoca  {3}  alco91ca alco91ca alco95ca;
array satfca  {3}  sat91ca sat91ca sat95ca;
array satfdenca  {3}  satden91ca satden91ca satden95ca;
array monfca  {3}  mon91ca mon91ca mon95ca;
array monfdenca  {3}  monden91ca monden91ca monden95ca ;
array polyfca  {3}  poly91ca poly91ca poly95c;
array polyfdenca  {3}  polyden91ca polyden91ca polyden95ca;
array transfca  {3}  trnss91ca trnss91ca trnss95ca;
array transfdenca  {3}  transden91ca transden91ca transden95ca;
array folca  {3}  fol91ca fol91ca fol95ca;
array protca  {3}  prot91ca prot91ca prot95ca;
array protdenca  {3}  protden91ca protden91ca protden95ca;
array gidca  {3}  gid91ca gid91ca gid95ca;
array carboca  {3}  carbo91ca carbo91ca carbo95ca;
array carbdenca  {3}  carbden91ca carbden91ca carbden95ca;

array calor  {3}  calor91n calor91n calor95n;
array carbo  {3}  carbo91n carbo91n carbo95n;
array carbden  {3}  carbden91n carbden91n carbden95n;
array prot  {3}  prot91n prot91n prot95n;
array protden  {3}  protden91n protden91n protden95n;
array alco  {3}  alco91n alco91n alco95n;
array ceraf  {3}  ceraf91n ceraf91n ceraf95n;
array aofib  {3}  aofib91n aofib91n aofib95n;
array polyf  {3}  poly91n poly91n poly95n;
array polyfden  {3}  polyden91n polyden91n polyden95n;
array transf  {3}  trnss91n trnss91n trnss95n;
array transfden  {3}  transden91n transden91n transden95n;
array satf  {3}  sat91n sat91n sat95n;
array satfden  {3}  satden91n satden91n satden95n;
array monf  {3}  mon91n mon91n mon95n;
array monfden  {3}  monden91n monden91n monden95n;

array tpotat  {3}  tpotat91d tpotat91d tpotat95d;
array bbmpot  {3}  bbmpot91d bbmpot91d bbmpot95d;
array fpotat  {3}  fpotat91d fpotat91d fpotat95d;
array chipss  {3}  chipss91d chipss91d chipss95d ;
array prmeat  {3}  prmeat91d prmeat91d prmeat95d ;
array urmeat  {3}  urmeat91d urmeat91d urmeat95d ;
array trmeat  {3}  trmeat91d trmeat91d trmeat95d ;
array poultr  {3}  poultr91d poultr91d poultr95d ;
array fishal  {3}  fishal91d fishal91d fishal95d ;
array regegg  {3}  regegg91d regegg91d regegg95d ;
array hdairy  {3}  hdairy91d hdairy91d hdairy95d ;
array ldairy  {3}  ldairy91d ldairy91d ldairy95d ;
array nutsal  {3}  nutsal91d nutsal91d nutsal95d ;
array legume  {3}  legume91d legume91d legume95d ;
array fruits  {3}  fruits91d fruits91d fruits95d ;
array vegeal  {3}  vegeal91d vegeal91d vegeal95d ;
array nstveg  {3}  nstveg91d nstveg91d nstveg95d ;
array staveg  {3}  staveg91d staveg91d staveg95d ;
array tdairy  {3}  tdairy91d tdairy91d tdairy95d ;
array coffee  {3}  coffee91d coffee91d coffee95d ;
array nutleg  {3}  nutleg91d nutleg91d nutleg95d ;
array bwrice  {3}  bwrice91d bwrice91d bwrice95d ;
array wtrice  {3}  wtrice91d wtrice91d wtrice95d ;
array SSB     {3}  SSB91d SSB91d SSB95d;
array whgrns  {3}  whgrns91d whgrns91d whgrns95d;
array rfgrns  {3}  rfgrns91d rfgrns91d rfgrns95d;
array whgrn  {3}  whgrn91n whgrn91n whgrn95n;
array rfgrn  {3}  rfgrn91n rfgrn91n rfgrn95n;
array gl  {3}  gl91n gl91n gl95n;
array gid  {3}  gid91n gid91n gid95n;


array tpotatca  {3}  tpotat91ca tpotat91ca tpotat95ca;
array bbmpotca  {3}  bbmpot91ca bbmpot91ca bbmpot95ca;
array fpotatca  {3}  fpotat91ca fpotat91ca fpotat95ca ;
array chipssca  {3}  chipss91ca chipss91ca chipss95ca ;
array prmeatca  {3}  prmeat91ca prmeat91ca prmeat95ca ;
array urmeatca  {3}  urmeat91ca urmeat91ca urmeat95ca ;
array trmeatca  {3}  trmeat91ca trmeat91ca trmeat95ca ;
array poultrca  {3}  poultr91ca poultr91ca poultr95ca ;
array fishalca  {3}  fishal91ca fishal91ca fishal95ca ;
array regeggca  {3}  regegg91ca regegg91ca regegg95ca ;
array hdairyca  {3}  hdairy91ca hdairy91ca hdairy95ca ;
array ldairyca  {3}  ldairy91ca ldairy91ca ldairy95ca ;
array nutsalca  {3}  nutsal91ca nutsal91ca nutsal95ca ;
array legumeca  {3}  legume91ca legume91ca legume95ca ;
array fruitsca  {3}  fruits91ca fruits91ca fruits95ca ;
array vegealca  {3}  vegeal91ca vegeal91ca vegeal95ca ;
array nstvegca  {3}  nstveg91ca nstveg91ca nstveg95ca ;
array stavegca  {3}  staveg91ca staveg91ca staveg95ca ;
array tdairyca  {3}  tdairy91ca tdairy91ca tdairy95ca ;
array coffeeca  {3}  coffee91ca coffee91ca coffee95ca ;
array nutlegca  {3}  nutleg91ca nutleg91ca nutleg95ca ;
array bwriceca  {3}  bwrice91ca bwrice91ca bwrice95ca ;
array wtriceca  {3}  wtrice91ca wtrice91ca wtrice95ca ;
array SSBca     {3}  SSB91ca SSB91ca SSB95ca;
array whgrnsca  {3}  whgrns91ca whgrns91ca whgrns95ca;
array rfgrnsca  {3}  rfgrns91ca rfgrns91ca rfgrns95ca;
array whgrnca  {3}  whgrn91ca whgrn91ca whgrn95ca;
array rfgrnca  {3}  rfgrn91ca rfgrn91ca rfgrn95ca ;
array glca  {3}  gl91ca gl91ca gl95ca ;

array ahei       {3}  ahei91 ahei91 ahei95; 
array aheinoal   {3}  aheinoal91 aheinoal91 aheinoal95; 
array aheinopt   {3}  aheinopt91 aheinopt91 aheinopt95; 
array aheifisha  {3}  aheifisha91 aheifisha91 aheifisha95;
array aheidairy  {3}  aheidairy91 aheidairy91 aheidairy95;
array aheinutbl  {3}  aheinutbl91 aheinutbl91 aheinutbl95;
array aheipoult  {3}  aheipoult91 aheipoult91 aheipoult95;
array aheineggs  {3}  aheineggs91 aheineggs91 aheineggs95;

array aheica       {3}  ahei91ca ahei91ca ahei95ca ; 
array aheinoalca   {3}  aheinoal91ca aheinoal91ca aheinoal95ca ; 
array aheinoptca   {3}  aheinopt91ca aheinopt91ca aheinopt95ca ;
array aheifishaca  {3}  aheifisha91ca aheifisha91ca aheifisha95ca ;
array aheidairyca  {3}  aheidairy91ca aheidairy91ca aheidairy95ca ;
array aheinutblca  {3}  aheinutbl91ca aheinutbl91ca aheinutbl95ca ;
array aheipoultca  {3}  aheipoult91ca aheipoult91ca aheipoult95ca ;
array aheineggsca  {3}  aheineggs91ca aheineggs91ca aheineggs95ca ;

/*****************************************************************************;
* Individual SES data /
*****************************************************************************/
array alone {3} alone93 alone93 alone93; 
              
array married {3} mar89 marry93 marry93; 
...
*****************************************************************************/
   ...
   array inc {3} mdinc90_91 mdinc90_93 mdinc00_95;
   array vhs {3} mdvhs90_91 mdvhs90_93 mdvhs00_95;
   array pcoll {3} pcolled90_91 pcolled90_93 pcolled00_95;
   array phs {3} phs90_91 phs90_93 phs00_95;
   array pnohs {3} pnohs90_91 pnohs90_93 pnohs00_95;
   array pfint {3} pfaminterest90_91 pfaminterest90_93 pfaminterest00_95;
   array sfemale {3} pfwchbf90_91 pfwchbf90_93 pfwchbf00_95;
   array pkid {3} pkid90_91 pkid90_93 pkid00_95;
   array pold {3} pold90_91 pold90_93 pold00_95;
   array pohse {3} pohse90_91 pohse90_93 pohse00_95;        
   array ppov {3} ppov90_91 ppov90_93 ppov00_95;
   array pw {3}   pwht90_91 pwht90_93 pwht00_95;
         
   array popd {3} popd90_91 popd90_93 popd00_95;              
   array div {3} division10_91 division10_93 division10_95;
   array reg {3} region10_91 region10_93 region10_95;
...
*************************************************************************/
 cutoff=1458;    
   do i=1 to DIM(irt)-1;
      if (irt{i}<(1362+24*i) | irt{i}>=(1386+24*i)) then irt{i}=1362+24*i;
   end;  
...
keep id period agecon agegp agedi smkdi smkk chol91 tpotatw fpotatow chipssw bbmpotw whgrnsw rfgrnsw nstvegw stavegw legumew 
     retmo15 retmo17 retmo19 cutoff
     t15 t17 t19  dtdth dtdxdiab
...
varlist= calorcav calorv carbov carbdenv carbocav carbdencav alcov alcocav protcav protv protdencav protdenv aofibv aofibcav cerafv cerafcav transfv transfdenv transfcav transfdencav satfv satfdenv satfcav satfdencav polyfv polyfdenv polyfcav polyfdencav monfcav monfv monfdencav monfdenv
         prmeatv urmeatv trmeatv poultrv hdairyv ldairyv /*soyprov*/ prmeatcav urmeatcav trmeatcav poultrcav fishalcav regeggcav hdairycav ldairycav /*soyprocav*/ nutsalcav legumecav fruitscav vegealcav nstvegcav stavegcav gidcav whgrns91d rfgrns91d whgrnscav rfgrnscav SSBcav
...
%indic3(vbl=qregeggv, prefix=qregeggv, reflev=0, min=1, max=4, missing=., usemiss=0);
      ...
      if fishalv=0.000 then qfishalv=0;
      else if 0.000<fishalv<=0.070 then qfishalv=1;          
      else if 0.070<fishalv<=0.143 then qfishalv=2;        
      else if 0.143<fishalv<=0.430 then qfishalv=3;         
      else if 0.430<fishalv then qfishalv=4;                 
%indic3(vbl=qfishalv, prefix=qfishalv, reflev=0, min=1, max=4, missing=., usemiss=0);
run;
...
proc freq data=five;tables qSSBv qfishalv qregeggv;run; 


%mphreg9(data=five, event=diabcase, time=tdiabcase,  
         timevar=t15  t17  t19,
         id=id, tvar=period,
         agevar=agecon, qret= retmo15 retmo17 retmo19, cutoff=cutoff,
