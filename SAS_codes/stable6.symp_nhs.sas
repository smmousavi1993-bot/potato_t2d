...
Purpose of the program: 
   S.Table 6. Associations between potato intakes and risk of diabetes in the NHS (symptomatic cases of diabetes at diagnosis )
...
ods rtf file="stable6.symp_nhs.rtf";  
...
ods rtf file="stable6.symp.bbm_nhs.rtf";  
proc print data=scr noobs;
...
ods rtf file="stable6.symp_pserv_nhs.rtf";  
