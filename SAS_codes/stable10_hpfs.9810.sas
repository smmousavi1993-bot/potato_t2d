...
%hp_diab8622;
    ...
    dtdxdiab = dtdx*1;
    if dtdxdiab = . then dtdxdiab = 1175;
...
array wt  {18}  wt86    wt88    wt90    wt92    wt94    wt96    wt98    wt00     wt02     wt04     wt06      wt08  wt10  wt12  wt14 wt16 wt18  wt20;
array bmi     {18}  bmi86   bmi88   bmi90   bmi92   bmi94   bmi96   bmi98   bmi00    bmi02    bmi04    bmi06     bmi08   bmi10   bmi12   bmi14 bmi16 bmi18 bmi20;
array smoke    {18}  smoke86 smoke88 smoke90 smoke92 smoke94 smoke96 smoke98 smoke00  smoke02  smoke04  smoke06   smoke08  smoke10  smoke12  smoke14 smoke16 smoke18 smoke20;
array cgnm   {18}  cgnm86  cgnm88  cgnm90  cgnm92  cgnm94  cgnm96  cgnm98  cgnm00   cgnm02   cgnm04   cgnm06    cgnm08  cgnm10   cgnm12    cgnm14 cgnm16 cgnm18 cgnm20;
array smm     {18}  smm86   smm88   smm90   smm92   smm94   smm96   smm98   smm00    smm02    smm04    smm06     smm08    smm10    smm12     smm14 smm16 smm18 smm20;
...
array rtmnyr   {7} rtmnyr98 rtmnyr00 rtmnyr02 rtmnyr04 rtmnyr06 rtmnyr08 cutoff;
...
array aspi  {6}  asp96 asp00 asp02 asp04 asp06 asp08 ;
array hbp   {6}  hbp98 hbp00 hbp02 hbp04 hbp06 hbp08 ;
array chol  {6}  chol98   chol00   chol02   chol04   chol06  chol08;
array db {6}  db98  db00  db02  db04  db06  db08;

array smoke {6}  smoke98  smoke00  smoke02  smoke04  smoke06  smoke08;
array cgnm  {6}  cgnm98   cgnm00   cgnm02   cgnm04   cgnm06   cgnm08;
array smm   {6}  smm98 smm00 smm02 smm04 smm06 smm08;
array bmi   {6}  bmi98   bmi00    bmi02    bmi04    bmi06     bmi08 ;
array bmicq {6}  bmic98   bmic00   bmic02   bmic04   bmic06  bmic08 ;
...
array alcq  {12}  alc86 alc88 alc90 alc92 alc94 alc96 alc98 alc00 alc02 alc04 alc06 alc08;
array actm  {6}  act98 act00 act02 act04 act06 act08;
array antitc   {6} hchtx98  hchtx00  hchtx02  hchtx04  hchtx06  hchtx08 ; 
array repcabg   {12}  cabg86  cabg88  cabg90  cabg92 cabg94  cabg96  cabg98  cabg00   cabg02   cabg04   cabg06 cabg08 ; 
array ang   {12}  ang86  ang88  ang90  ang92  ang94  ang96  ang98  ang00   ang02   ang04   ang06 ang08; 
array antihp   {6}  htnrx98  htnrx00  htnrx02  htnrx04  htnrx06  htnrx08;
array mvit    {6}   mvit98 mvit98 mvit02 mvit02 mvit06 mvit06;

/*Statin*/
array statin {6}   hchtx98 chrx00 chrx02 chrx04 chrx06 chrx08;
...
array soypro  {12}  soypro86d soypro86d soypro90d soypro90d soypro94d soypro94d soypro98d soypro98d soypro02d soypro02d soypro06d soypro06d;
...
array transfca  {12}  trnss86ca trnss86ca trnss90ca trnss90ca trnss94ca trnss94ca ttrn098ca ttrn098ca trn0202ca trn0202ca trn0706ca trn0706ca ;
...
array soyproca  {12}  soypro86ca soypro86ca soypro90ca soypro90ca soypro94ca soypro94ca soypro98ca soypro98ca soypro02ca soypro02ca soypro06ca soypro06ca ;
...
*****************************************************************************/
   ...
   array pfint {6} pfaminterest00_98 pfaminterest00_00 pfaminterest00_02 pfaminterest00_04 pfaminterest10_06 pfaminterest10_08;
...
*************************************************************************/
 cutoff=1321;    
   do i=1 to DIM(irt)-1;
      if (irt{i}<(1153+24*i) | irt{i}>=(1177+24*i)) then irt{i}=1153+24*i;
   end;  
...
if hbp86 = 1 or hbp88 = 1 or hbp90 = 1 or hbp92 = 1 or hbp94 = 1  or hbp96 = 1 or hbp98 = 1 then hbp86 = 1; else hbp86 = 0;
if db86 = 1 or db88 = 1 or db90 = 1 or db92 = 1 or db94 = 1  or db96 = 1 or db98 = 1 then hxdb = 1; else hxdb = 0;
if can86 = 1 or can88 = 1 or can90 = 1 or can92 = 1 or can94 = 1  or can96 = 1 or can98 = 1 then hxcan = 1; else hxcan = 0;
if mi86 = 1 or mi88 = 1 or mi90 = 1 or mi92 = 1 or mi94 = 1  or mi96 = 1 or mi98 = 1 or
cabg86 = 1 or cabg88 = 1 or cabg90 = 1 or cabg92 = 1 or cabg94 = 1  or cabg96 = 1 or cabg98 = 1 or
ang86 = 1 or ang88 = 1 or ang90 = 1 or ang92 = 1 or ang94 = 1  or ang96 = 1 or ang98 = 1 or
str86 = 1 or str88 = 1 or str90 = 1 or str92 = 1 or str94 = 1  or str96 = 1 or str98 = 1 then cvd86 = 1; else cvd86 = 0;
...
division=div{i};
   ...
   %exclude(0 lt dtdxdiab le irt98);          /* Diagnoses diabetes before 1991 */
...
keep id period dtdth agecon agegp bmidi agedi hxcan hxdb
    ...
    t98 t00 t02 t04 t06 t08 newicda tdiabcase diabcase dtdxdiab
    ...
    antihbp antihtc cvd86 whgrns86d rfgrns86d
     age98 bmi98 alco86n calor86n act98 statindi eth3g &strrace_
...
ods rtf file="stable10_hpfs.9810.rtf";  
...
ods rtf file="stable10_hpfs.bbm.9810.rtf";  
proc print data=scr noobs;
...
ods rtf file="stable10_hpfs.9810.pserv.rtf";  
