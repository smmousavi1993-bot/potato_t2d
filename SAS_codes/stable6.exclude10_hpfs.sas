/******************************************************************************************************************************************
Program name: /udd/nhsem/Potato.T2D/HPFS/prep_hpfs.sas
...
division=div{i};
   ...
   %exclude(0 lt dtdxdiab le irt96);          /* Diagnoses diabetes 10 years after baseline (1986) */
...
/*baked, Bolied, Mashed potato Person-time*/
%pre_pm(
 data=five,
 out=outpm,
 timevar=period,
...
ods rtf file="stable6.exclude10_bbm_hpfs.rtf";  
proc print data=scr noobs;
...
ods rtf file="stable6.exclude10_pserv_hpfs.rtf";  
