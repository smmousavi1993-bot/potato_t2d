...
Purpose of the program: 
   S.Table 8. Associations between cumulative average with the most recent three potato intakes and risk of diabetes in the NHS, NHS II, and HPFS using different types of dietary assessments
...
do i = 1 to DIM(nocum91);
        ...
        cumul03{i} = mean(nocum95{i}, nocum99{i}, nocum03{i});
        cumul07{i} = mean(nocum99{i}, nocum03{i}, nocum07{i});
        cumul11{i} = mean(nocum03{i}, nocum07{i}, nocum11{i});
        cumul15{i} = mean(nocum07{i}, nocum11{i}, nocum15{i});
        cumul19{i} = mean(nocum11{i}, nocum15{i}, nocum19{i});
end;
...
data five;
  ...
  %indic3(vbl=ctpotatcav, prefix=ctpotatcav, reflev=0, min=1, max=4, missing=., usemiss=0);
   ...
   if ctpotatcav=0 then medctpotatcav=0.0466667;
   ...
   if ctpotatcav=4 then medctpotatcav=0.8800000;
...
%indic3(vbl=cchipsscav, prefix=cchipsscav, reflev=0, min=1, max=4, missing=., usemiss=0);
   ...
   if cchipsscav=1 then medcchipsscav=0.0466667;
...
%indic3(vbl=cfpotatcav, prefix=cfpotatcav, reflev=0, min=1, max=4, missing=., usemiss=0);
   ...
   if cfpotatcav=1 then medcfpotatcav=0.0466667;
   if cfpotatcav=2 then medcfpotatcav=0.1166667;
...
ods rtf file="stable8.rect_nhs2.rtf";  
...
ods rtf file="stable8.rect_pserv_nhs2.rtf";  
...
ods rtf file="stable8.rect.bbm_nhs2.rtf";  
proc print data=scr noobs;
