...
Purpose of the program: 
   S.Table 6. Associations between potato intakes and risk of diabetes in the NHS II (Stop updating of diet after an intermediate outcome)
...
/*Intermediate diagnosis mark missing MI, Angina, CABG*/
              if cabg91=1 or mi91=1 or ang91=1 then do;nocum91{i}=.;nocum95{i}=.; nocum99{i}=.; nocum03{i}=.; nocum07{i}=.; nocum11{i}=.; nocum15{i}=.; nocum19{i}=.;end;
              if cabg93=1 or mi93=1 or ang93=1 then do;nocum95{i}=.; nocum99{i}=.; nocum03{i}=.; nocum07{i}=.; nocum11{i}=.; nocum15{i}=.; nocum19{i}=.;end;
              if cabg95=1 or mi95=1 or ang95=1 then do;nocum95{i}=.; nocum99{i}=.; nocum03{i}=.; nocum07{i}=.; nocum11{i}=.; nocum15{i}=.; nocum19{i}=.;end;
              if cabg97=1 or mi97=1 or ang97=1 then do;nocum99{i}=.; nocum03{i}=.; nocum07{i}=.; nocum11{i}=.; nocum15{i}=.; nocum19{i}=.;end;
              if cabg99=1 or mi99=1 or ang99=1 then do;nocum99{i}=.; nocum03{i}=.; nocum07{i}=.; nocum11{i}=.; nocum15{i}=.; nocum19{i}=.;end;
              if cabg01=1 or mi01=1 or ang01=1 then do;nocum03{i}=.; nocum07{i}=.; nocum11{i}=.; nocum15{i}=.; nocum19{i}=.;end;
              if cabg03=1 or mi03=1 or ang03=1 then do;nocum03{i}=.; nocum07{i}=.; nocum11{i}=.; nocum15{i}=.; nocum19{i}=.;end;
              if cabg05=1 or mi05=1 or ang05=1 then do;nocum07{i}=.; nocum11{i}=.; nocum15{i}=.; nocum19{i}=.;end;
              if cabg07=1 or mi07=1 or ang07=1 then do;nocum07{i}=.; nocum11{i}=.; nocum15{i}=.; nocum19{i}=.;end;
              if cabg09=1 or mi09=1 or ang09=1 then do;nocum11{i}=.; nocum15{i}=.; nocum19{i}=.;end;
              if cabg11=1 or mi11=1 or ang11=1 then do;nocum11{i}=.; nocum15{i}=.; nocum19{i}=.;end;
              if cabg13=1 or mi13=1 or ang13=1 then do;nocum15{i}=.; nocum19{i}=.;end;
              if cabg15=1 or mi15=1 or ang15=1 then do;nocum15{i}=.; nocum19{i}=.;end;
              if cabg17=1 or mi17=1 or ang17=1 then do;nocum19{i}=.;end;
              if cabg19=1 or mi19=1 or ang19=1 then do;nocum19{i}=.;end;
...
keep id period agecon agegp agedi smkdi smkk chol91 tpotatw fpotatow chipssw bbmpotw whgrnsw rfgrnsw nstvegw stavegw legumew bwricew wtricew 
...
ods rtf file="stable6.stop_nhs2.rtf";  
...
ods rtf file="stable6.stop.bbm_nhs2.rtf";  
proc print data=scr noobs;
...
ods rtf file="stable6.stop_pserv_nhs2.rtf";  
