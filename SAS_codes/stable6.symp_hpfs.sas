...
Purpose of the program: 
   S.Table 6. Associations between potato intakes and risk of diabetes in the HPFS by intake categories (Symptomatic diabetes cases)
...
ods rtf file="stable6.symp_hpfs.rtf";  
...
ods rtf file="stable6.symp.bbm_hpfs.rtf";  
proc print data=scr noobs;
...
ods rtf file="stable6.symp_pserv_hpfs.rtf";  
