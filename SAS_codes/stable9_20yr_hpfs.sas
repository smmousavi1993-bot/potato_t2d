...
array rtmnyr   {7} rtmnyr06 rtmnyr08 rtmnyr10 rtmnyr12 rtmnyr14 rtmnyr16 cutoff;
array irt   {7} irt06 irt08 irt10 irt12 irt14 irt16 cutoff;
array perioda  {6}  period1  period2  period3  period4  period5  period6 ;
array tvar  {6}  t06   t08   t10   t12   t14   t16;
...
*************************************************************************/
  cutoff=1417;    
   do i=1 to DIM(irt)-1;
      if (irt{i}<(1249+24*i) | irt{i}>=(1273+24*i)) then irt{i}=1249+24*i;
   end;  
...
keep id period dtdth agecon agegp bmidi agedi 
     irt06 irt08 irt10 irt12 irt14 irt16   cutoff
     t06 t08 t10 t12 t14 t16   newicda tdiabcase diabcase dtdxdiab
    dead tdead 
...
%mphreg9(data=five, event=diabcase, time=tdiabcase,  
         timevar=t06 t08 t10 t12 t14 t16  ,
         id=id, tvar=period,
         agevar=agecon, qret=irt06 irt08 irt10 irt12 irt14 irt16  , cutoff=cutoff,
