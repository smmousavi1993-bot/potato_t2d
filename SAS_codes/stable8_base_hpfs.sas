...
Purpose of the program: 
   S.Table 8. Associations between baseline potato intakes and risk of diabetes in the HPFS using different types of dietary assessments
...
varlist=calorcav calorv alcov alcocav prmeatv urmeatv trmeatv poultrv fishalv regeggv hdairyv ldairyv tdairyv nutlegv legumev fruitsv soyprov nstvegv stavegv bwricev wtricev SSBv
        tpotatcav bbmpotcav fpotatcav chipsscav prmeatcav urmeatcav trmeatcav poultrcav hdairycav ldairycav soyprocav nutsalcav legumecav fruitscav vegealcav nstvegcav stavegcav gidcav SSBcav tdairycav nutlegcav bwricecav wtricecav
...
ods rtf file="stable8.base_hpfs.rtf";  
...
ods rtf file="stable8.base_pserv_hpfs.rtf";  
...
ods rtf file="stable8.base.bbm_hpfs.rtf";  
proc print data=scr noobs;
