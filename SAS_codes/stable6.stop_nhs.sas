...
Purpose of the program: 
   S.Table 6. Associations between potato intakes and risk of diabetes in the NHS (Stop updating of diet after an intermediate outcome)
...
/*Intermediate diagnosis mark missing MI, Angina, CABG*/
              if cabg84=2 or hrt84 in (1,2) then do;nocum84{i}=.;nocum86{i}=.; nocum90{i}=.; nocum94{i}=.; nocum98{i}=.; nocum02{i}=.; nocum06{i}=.; nocum10{i}=.;end;
              if cabg86=1 or hrt86 in (1,2) then do;nocum86{i}=.; nocum90{i}=.; nocum94{i}=.; nocum98{i}=.; nocum02{i}=.; nocum06{i}=.; nocum10{i}=.;end;
              if cabg88=1 or hrt88 in (1,2) then do;nocum90{i}=.; nocum94{i}=.; nocum98{i}=.; nocum02{i}=.; nocum06{i}=.; nocum10{i}=.;end;
              if cabg90=1 or hrt90 in (1,2) then do;nocum90{i}=.; nocum94{i}=.; nocum98{i}=.; nocum02{i}=.; nocum06{i}=.; nocum10{i}=.;end;
              if cabg92=1 or hrt92 in (1,2) then do;nocum94{i}=.; nocum98{i}=.; nocum02{i}=.; nocum06{i}=.; nocum10{i}=.;end;
              if cabg94=1 or hrt94 in (1,2) then do;nocum94{i}=.; nocum98{i}=.; nocum02{i}=.; nocum06{i}=.; nocum10{i}=.;end;
              if cabg96=1 or hrt96 in (1,2) then do;nocum98{i}=.; nocum02{i}=.; nocum06{i}=.; nocum10{i}=.;end;
              if cabg98=1 or hrt98 in (1,2) then do;nocum98{i}=.; nocum02{i}=.; nocum06{i}=.; nocum10{i}=.;end;
              if cabg00=1 or hrt00 in (1,2) then do;nocum02{i}=.; nocum06{i}=.; nocum10{i}=.;end;
              if cabg02=1 or hrt02 in (1,2) then do;nocum02{i}=.; nocum06{i}=.; nocum10{i}=.;end;
              if cabg04=1 or hrt04 in (1,2) then do;nocum06{i}=.; nocum10{i}=.;end;
              if cabg06=1 or hrt06 in (1,2) then do;nocum06{i}=.; nocum10{i}=.;end;
              if cabg08=1 or hrt08 in (1,2) then do;nocum10{i}=.;end;
              if cabg10=1 or hrt10 in (1,2) then do;nocum10{i}=.;end;
...
keep id period agecon agegp agedi smkdi smkk chol84 tpotatw fpotatow chipssw bbmpotw whgrnsw rfgrnsw nstvegw stavegw legumew tpotatwv fpotatowv chipsswv bbmpotwv whgrnswv rfgrnswv nstvegwv stavegwv legumewv bwricew wtricew 
...
/*create quintiles for SSBv
proc rank data=two groups=5 out=two_new;
var SSBv; 
ranks SSBvq;
run;
...
proc freq data=two;tables SSBvq;run;
endsas;*/
...
ods rtf file="stable6.stop_nhs.rtf";  
...
/*Baked, Boiled, or Mashed potato Person-time*/
%pre_pm(
 data=five,
 out=outpm,
 timevar=period,
...
ods rtf file="stable6.stop.bbm_nhs.rtf";  
proc print data=scr noobs;
...
ods rtf file="stable6.stop_pserv_nhs.rtf";  
